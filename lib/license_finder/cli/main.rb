...
module LicenseFinder
  module CLI
    class Main < Base
      ...
      class_option :conda_bash_setup_script, desc: "Path to conda.sh script. Only meaningful if used with a Conda project. Defaults to '/root/miniconda3/etc/profile.d/conda.sh'."
